...
export const STRINGS = {
  ...
  de: {
    ...
    spiritType: 'Geisttyp',
    force: 'Kraftstufe',
    spiritNamePlaceholder: 'Geistname (optional)',
    ...
    noSpirits: 'Kein Geist beschworen.',
    needSpiritCatalog: 'Importiere einen Geistkatalog (auf dem Charakter-Bildschirm), um einen Geist zu beschwören.',
    spiritNamePrompt: 'Geistname (leer lassen, um den Typnamen zu verwenden):',
    removeSpiritConfirm: (name) => `${name} entlassen?`,
    loadSpiritCatalog: 'Geistkatalog laden',
    clearSpiritCatalog: 'Geistkatalog löschen',
    spiritCatalogStatus: (n) => `Geistkatalog: ${n} Geist`,
    noSpiritCatalog: 'Kein Geistkatalog geladen',
    spiritCatalogLoaded: (n) => `${n} Geist geladen.`,
    spiritCatalogInvalid: 'Diese Datei ist kein Geistkatalog.',
    clearSpiritCatalogConfirm: 'Geladenen Geistkatalog löschen?',
  },
};
