...
export const STRINGS = {
  en: {
    ...
    switchAmmo: 'Switch',
    switchAmmoTitle: 'Switch ammo',
    noPoolsToSwitch: 'No reserve pools for this weapon type. Add one under Reserve ammo.',
    ...
    // Attack rating (5 range bands)
    attackRating: 'AR',
    attackRatingTitle: 'Attack rating',
    editAttackRating: 'Edit attack rating',
    arClose: 'Close',
    arNear: 'Near',
    arMedium: 'Medium',
    arFar: 'Far',
    arExtreme: 'Extreme',
    arBlankHint: 'Leave a band empty when the weapon has no rating at that range.',
    save: 'Save',
    ...
    optionalPowersLabel: 'Optional powers',
    optionalPowersCount: (sel, cap) => `${sel} of ${cap} selected`,
    services: 'Services',
    innatePowers: 'Powers',
    skillsLabel: 'Skills',
    ...
    astralInitiativeLabel: 'Astral initiative',
  ...
  de: {
    ...
    switchAmmo: 'Wechseln',
    switchAmmoTitle: 'Munition wechseln',
    noPoolsToSwitch: 'Keine Reservepools für diesen Waffentyp. Lege einen unter Reservemunition an.',
    ...
    // Angriffswert (5 Entfernungsstufen)
    attackRating: 'AW',
    attackRatingTitle: 'Angriffswert',
    editAttackRating: 'Angriffswert bearbeiten',
    arClose: 'Nah',
    arNear: 'Kurz',
    arMedium: 'Mittel',
    arFar: 'Weit',
    arExtreme: 'Extrem',
    arBlankHint: 'Feld leer lassen, wenn die Waffe auf diese Entfernung keinen Wert hat.',
    save: 'Speichern',
    cancel: 'Abbrechen',
    add: 'Hinzufügen',
    ...
    optionalPowersLabel: 'Zusätzliche Kräfte',
    optionalPowersCount: (sel, cap) => `${sel} von ${cap} ausgewählt`,
    services: 'Dienste',
    innatePowers: 'Kräfte',
    skillsLabel: 'Fertigkeiten',
    weaknessesLabel: 'Schwächen',
    conditionMonitor: 'Zustandsmonitor',
    initiativeLabel: 'Initiative',
    astralInitiativeLabel: 'Initiative (Astral)',
    actionsLabel: 'Handlungen',
